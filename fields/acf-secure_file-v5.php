...
/*
*  ACF Secure File Field Class
*
*  All the logic for this field type
*
*  @class 		acf_field_secure_file
*  @extends		acf_field
*/
...
if( !class_exists('acf_field_secure_file') ) :
	...
	<div class="show-if-value file-wrap acf-soh">
		...
		<div class="file-info">
			...
			<p>
				...
				<a data-name="filename" href="<?php echo $o['url']; ?>" target="_blank"><?php echo $o['title']; ?></a>
			</p>
			<!--<p>
...
<?php
	...
	*  @param	$input	
	*
	*  @return	$valid - the modified value
	*/
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-secure_file', "{$url}assets/js/input.js", array('acf-input'), $version );
		wp_enqueue_script( 'acf-input-secure_file' );
...
// initialize
new acf_field_secure_file( $this->settings );
